...
class Main extends PluginBase implements Listener{
	...
	public function onEnable(){
		...
		$this->getServer()->getPluginManager()->registerEvents(new \_64FF00\PurePerms\EventListener($this), $this);
		$this->getServer()->getCommandMap()->register('addnpc', new \_64FF00\PurePerms\Commands\addnpcCommand($this));
